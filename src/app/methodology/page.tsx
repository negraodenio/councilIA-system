      ...
      <div className="relative h-[70vh] flex items-center justify-center overflow-hidden border-b border-[#38bdf8]/10 pt-16">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-[#38bdf8]/10 border border-[#38bdf8]/20 mb-6 animate-pulse">
            ...
            <span className="text-[10px] font-bold tracking-[0.2em] text-[#38bdf8] uppercase">Protocolo Auditável v7.3.1</span>
          </div>
          ...
          <p className="text-lg md:text-2xl text-[#d1d5db]/80 max-w-2xl mx-auto leading-relaxed font-light">
            Da impressão heurística de IA para a deliberação metrológica determinística. 
            A ciência da verdade auditável em ambientes de alta criticidade.
          </p>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-24 relative z-10">
        ...
        <section className="mb-40">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <div className="inline-block px-3 py-1 bg-white/5 border border-white/10 rounded text-[10px] font-mono text-[#38bdf8] uppercase tracking-widest mb-4">Evolução de Sistemas</div>
              <h2 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tight uppercase tracking-tighter italic">Separação entre <br/><span className="text-[#38bdf8]">Lógica e Narrativa</span></h2>
              <p className="text-xl text-[#d1d5db]/70 mb-10 leading-relaxed font-light">
                O CouncilIA v7.3.1 resolve o "gap de alucinação" separando estritamente a 
                **Camada de Lógica Matemática** da **Camada de Narrativa Semântica**. 
                Os indicadores são calculados via fórmulas estatísticas ISO antes de qualquer texto ser gerado.
              </p>
              <div className="grid grid-cols-1 gap-6">
                <div className="flex items-start space-x-6 p-6 rounded-2xl bg-white/5 border border-white/10 group hover:border-[#38bdf8]/30 transition-all">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">LLM gera texto e notas simultaneamente. Alto risco de contradição lógica.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-6 p-6 rounded-2xl bg-[#38bdf8]/10 border border-[#38bdf8]/30 group hover:border-[#38bdf8] transition-all">
                  ...
                  <div>
                    <h4 className="text-[#38bdf8] font-bold mb-1 uppercase text-sm tracking-widest">PRO HARNEDED (v7.3.1)</h4>
                    <p className="text-sm text-slate-300">Cálculo determinístico fixa a verdade inicial; o LLM é restrito à síntese de justificativas.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="mb-40">
          <div className="text-center mb-20">
            <div className="inline-block px-3 py-1 bg-white/5 border border-white/10 rounded text-[10px] font-mono text-[#d4a853] uppercase tracking-[0.4em] mb-4">Rigor Analítico</div>
            <h2 className="text-5xl md:text-6xl font-black text-white mb-6 uppercase tracking-tighter italic">A Matemática do <span className="text-[#d4a853]">Consenso</span></h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            <div className="bg-slate-900/50 p-12 rounded-[32px] border border-white/5 hover:border-[#38bdf8]/30 transition-all">
              <h3 className="text-3xl font-black text-[#38bdf8] mb-8 flex items-center uppercase italic tracking-tighter">
                <span className="mr-4 text-5xl">Θ</span> Força do Consenso
              </h3>
              <p className="text-lg mb-10 text-[#d1d5db]/60 leading-relaxed font-light">
                Mede a variância inversa entre as 6 personas especializadas. 
                O alinhamento é calculado como uma penalidade sobre o desvio padrão das notas.
              </p>
              <div className="bg-black/40 p-8 rounded-2xl font-mono text-lg border border-[#38bdf8]/20 mb-8 shadow-inner">
                <div className="text-[#38bdf8]/50 text-xs mb-2 uppercase tracking-widest font-bold">Pseudo-código do Protocolo</div>
                <div className="text-[#38bdf8]">σ = sqrt(Σ(xi - μ)² / N)</div>
                <div className="text-[#d4a853]">Θ = max(0, 100 - (σ * 2.5))</div>
              </div>
              <ul className="grid grid-cols-2 gap-4">
                <li className="p-4 rounded-xl bg-white/5 text-[10px] uppercase font-black text-slate-500 tracking-widest">100% = Alinhamento Absoluto</li>
                <li className="p-4 rounded-xl bg-white/5 text-[10px] uppercase font-black text-slate-500 tracking-widest">&lt;40% = Consenso Fraco</li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900/50 p-12 rounded-[32px] border border-white/5 hover:border-[#d4a853]/30 transition-all">
              <h3 className="text-3xl font-black text-[#d4a853] mb-8 flex items-center uppercase italic tracking-tighter">
                <span className="mr-4 text-5xl">VaR</span> Valor em Risco
              </h3>
              <p className="text-lg mb-10 text-[#d1d5db]/60 leading-relaxed font-light">
                Uma função de penalidade multidimensional que fatora a profundidade do impacto, 
                riscos não mitigados e densidade de evidências.
              </p>
              <div className="bg-black/40 p-8 rounded-2xl font-mono text-lg border border-[#d4a853]/20 mb-8 shadow-inner">
                <div className="text-[#d4a853]/50 text-xs mb-2 uppercase tracking-widest font-bold">Fórmula de Exposição</div>
                <div className="text-[#d4a853]">VaR = (Δ * wd) + (R * wr) + (E * we)</div>
              </div>
              <ul className="grid grid-cols-2 gap-4">
                <li className="p-4 rounded-xl bg-white/5 text-[10px] uppercase font-black text-slate-500 tracking-widest">Δ = Spread de Dissent</li>
                <li className="p-4 rounded-xl bg-white/5 text-[10px] uppercase font-black text-slate-500 tracking-widest">E = Densidade do RAG</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-40">
          <div className="bg-gradient-to-br from-indigo-950 to-slate-950 p-16 rounded-[48px] border border-white/10 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <h2 className="text-5xl md:text-7xl font-black text-white mb-10 tracking-tighter uppercase italic">O Protocolo <span className="text-[#38bdf8]">4-Guard</span></h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                {[
                  { label: 'Guardião 1', title: 'Logic Sync', desc: 'Verifica alinhamento Score vs Consenso', color: '#38bdf8' },
                  { label: 'Guardião 2', title: 'Neutral Leak', desc: 'Detecta fuga para neutralidade (50%)', color: '#d4a853' },
                  { label: 'Guardião 3', title: 'RAG Anchor', desc: 'Validação de fontes obrigatória', color: '#10b981' },
                  { label: 'Guardião 4', title: 'Solo Bias', desc: 'Anomalias de opinião única', color: '#f43f5e' }
                ].map((g, i) => (
              ...
              <div className="p-8 rounded-[32px] bg-red-500/10 border border-red-500/30 text-red-400">
                <p className="text-lg font-black flex items-center justify-center uppercase tracking-tight">
                   ...
                   A falha em qualquer guardião ativa o Safe Mode (REPROVADO POR INCONSISTÊNCIA).
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="text-center py-20 border-t border-white/10">
           <div className="inline-block px-3 py-1 bg-white/5 border border-white/10 rounded text-[10px] font-mono text-white/40 uppercase tracking-[0.5em] mb-12">Conselho de Auditoria Universal</div>
           ...
           <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              ...
              <Link href="/docs/COUNCILIA_V731_ESPECIFICACAO_CIENTIFICA.md" className="w-full md:w-auto px-12 py-5 rounded-full border border-white/20 text-white font-black uppercase tracking-widest text-sm hover:bg-white/5 transition-all">
